                ...
                <div className="relative p-6 flex-auto">
                  <div>
                    <h1 className="my-4 text-slate-500 text-lg leading-relaxed">
                      <span className="font-semibold">Turf Manager:</span>  {manager}
                    </h1>
                  </div>
                  <div>
                    <h2> <span className="font-semibold">Email:</span>   {managerEmail}</h2>
                    <h2><span className="font-semibold">Phone Number:</span>   {managerNumber}</h2>
                  </div>

                  <h2 className="pt-6 font-semibold "> <span>Kshs. </span>{rates} <span>/hour</span></h2>
                </div>
                <div>
                  <DateTimeValidation />
                </div>
